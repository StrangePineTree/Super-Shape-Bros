...
class lightAttack(attack):
	def __init__(self, owner: player.Player, x, y):
		super().__init__(owner, 0.15, .25, 60, 30, pygame.Rect(x + (25 if owner.direction == player.Player.RIGHT else -35), y-35, 60, 30), False)
...
class triDownAttack(attack):
	def __init__(self, owner: player.Player, x, y):
		super().__init__(owner, 0.4, .6, 80, 40, pygame.Rect(x-5, y-15, 30, 60), False)
